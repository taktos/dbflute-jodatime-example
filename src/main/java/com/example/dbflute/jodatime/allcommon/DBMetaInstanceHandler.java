package com.example.dbflute.jodatime.allcommon;
...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("MEMBER", "com.example.dbflute.jodatime.bsentity.dbmeta.MemberDbm");
        tmpMap.put("MEMBER_ADDRESS", "com.example.dbflute.jodatime.bsentity.dbmeta.MemberAddressDbm");
        tmpMap.put("MEMBER_FOLLOWING", "com.example.dbflute.jodatime.bsentity.dbmeta.MemberFollowingDbm");
        tmpMap.put("MEMBER_LOGIN", "com.example.dbflute.jodatime.bsentity.dbmeta.MemberLoginDbm");
        tmpMap.put("MEMBER_SECURITY", "com.example.dbflute.jodatime.bsentity.dbmeta.MemberSecurityDbm");
        tmpMap.put("MEMBER_SERVICE", "com.example.dbflute.jodatime.bsentity.dbmeta.MemberServiceDbm");
        tmpMap.put("MEMBER_STATUS", "com.example.dbflute.jodatime.bsentity.dbmeta.MemberStatusDbm");
        tmpMap.put("MEMBER_WITHDRAWAL", "com.example.dbflute.jodatime.bsentity.dbmeta.MemberWithdrawalDbm");
        tmpMap.put("PRODUCT", "com.example.dbflute.jodatime.bsentity.dbmeta.ProductDbm");
        tmpMap.put("PRODUCT_CATEGORY", "com.example.dbflute.jodatime.bsentity.dbmeta.ProductCategoryDbm");
        tmpMap.put("PRODUCT_STATUS", "com.example.dbflute.jodatime.bsentity.dbmeta.ProductStatusDbm");
        tmpMap.put("PURCHASE", "com.example.dbflute.jodatime.bsentity.dbmeta.PurchaseDbm");
        tmpMap.put("REGION", "com.example.dbflute.jodatime.bsentity.dbmeta.RegionDbm");
        tmpMap.put("SERVICE_RANK", "com.example.dbflute.jodatime.bsentity.dbmeta.ServiceRankDbm");
        tmpMap.put("SUMMARY_PRODUCT", "com.example.dbflute.jodatime.bsentity.dbmeta.SummaryProductDbm");
        tmpMap.put("SUMMARY_WITHDRAWAL", "com.example.dbflute.jodatime.bsentity.dbmeta.SummaryWithdrawalDbm");
        tmpMap.put("WITHDRAWAL_REASON", "com.example.dbflute.jodatime.bsentity.dbmeta.WithdrawalReasonDbm");
