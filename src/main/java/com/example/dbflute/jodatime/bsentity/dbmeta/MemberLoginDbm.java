...
public class MemberLoginDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberLoginId = cci("MEMBER_LOGIN_ID", "MEMBER_LOGIN_ID", null, null, true, "memberLoginId", Long.class, true, true, "BIGINT", 19, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_D0EF055A_6D51_4D3A_B681_8B6A899010D6", false, null, null, null, null, null);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.jodatime.exentity.MemberLogin"; }
    public String getConditionBeanTypeName() { return "com.example.dbflute.jodatime.cbean.MemberLoginCB"; }
    public String getBehaviorTypeName() { return "com.example.dbflute.jodatime.exbhv.MemberLoginBhv"; }
