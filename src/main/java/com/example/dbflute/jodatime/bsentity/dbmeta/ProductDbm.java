...
public class ProductDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnProductId = cci("PRODUCT_ID", "PRODUCT_ID", null, null, true, "productId", Integer.class, true, true, "INTEGER", 10, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_1F38B637_60E5_48A2_8A6A_2E16D73A6223", false, null, null, null, "purchaseList", null);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.jodatime.exentity.Product"; }
    public String getConditionBeanTypeName() { return "com.example.dbflute.jodatime.cbean.ProductCB"; }
    public String getBehaviorTypeName() { return "com.example.dbflute.jodatime.exbhv.ProductBhv"; }
